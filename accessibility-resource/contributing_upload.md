---
title: Contributing to the Accessibility Hub
sidebar_position: 1
hide_title: true
level: intermediate
type: overview
...
- Headings (H1â€“H6), nav labels, and primary link labels must be plain text; do not include emoji characters.
...
- Authoring rules:
  ...
  - If you keep emojis in body text, prefer `<span aria-hidden="true">ðŸ™‚</span>` with adjacent visible text. In MDX, wrap directly; in MD, rely on our build tooling.
- UI components:
...
## How to Contribute
Not sure where to start? Hereâ€™s how you can pitch in:
...
- Copy the [`/docs/.template.md`](https://github.com/alexarguello/accessibility-hub/blob/main/accessibility-resource/docs/.template.md) file as a starting point for your new resource.
- Rename your file (e.g., `screen-readers.md`, `dos-and-donts.md`).

âš ï¸ Do not name files `intro.md` or `index.md` â€” these are reserved for folder landing pages.
...
- Keep it **short and clear** (max 2â€“3 paragraphs).
...
âš ï¸ **Tip**: If thereâ€™s an issue or discussion related to your PR, reference it in the description!
...
Include your tags as **specific and accurate as possible** â€” these improve searchability and structure for other contributors.
...
## â€œPlannedâ€ or â€œWork in Progressâ€ Resources
